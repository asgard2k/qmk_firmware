...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_5x6(
       ...
       _______, _______,     _______, _______,       _______,        _______,                                     _______, KC_PERC, KC_MINS, KC_EQL , KC_BSLS, _______,
                             _______, _______,                                                                                      _______, _______,
                                                     _______,        _______,                                     _______, _______,
                                                                                          _______,       _______
  ),   
  ...
  [_FUNCTIONS] = LAYOUT_5x6(
       ...
       _______, _______, _______, _______, LCTL(KC_V), _______,                          KC_NLCK, LSFT(KC_F10), _______, _______, _______, _______,
                         _______, _______,                                                                      _______, _______,
