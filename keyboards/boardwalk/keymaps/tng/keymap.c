...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_ortho_5x14(
        C_S_T(KC_GRV),                 MT(MOD_LCTL|MOD_LSFT|MOD_LALT,KC_1), LT(_DVORAK,KC_2),    KC_3,           KC_4,               KC_5,                              DYN_MACRO_PLAY1,         DYN_MACRO_PLAY2,              KC_6,                KC_7,           KC_8,            KC_9,            KC_0,            LCAG_T(KC_ESC),
        MT(MOD_LCTL|MOD_LALT,KC_TAB),  KC_Q,                                KC_W,                KC_E,           LT(_MOUSE,KC_R),    KC_T,                              KC_PGUP,                 KC_HOME,                      KC_Y,                KC_U,           KC_I,            KC_O,            KC_P,            KC_DEL,
        LSFT_T(KC_CAPS),               KC_A,                                KC_S,                KC_D,           LT(_RAISE,KC_F),    KC_G,                              KC_PGDN,                 KC_END,                       KC_H,                KC_J,           KC_K,            KC_L,            KC_SCLN,         RSFT_T(KC_ENT),
        KC_LCTL,                       KC_Z,                                KC_X,                KC_C,           KC_V,               KC_B,                              KC_PGDN,                 KC_END,                       KC_N,                KC_M,           RALT_T(KC_COMM), RGUI_T(KC_DOT),  RCTL_T(KC_SLSH), RCTL_T(KC_QUOT),
        KC_LCTL,                       KC_LGUI,                             KC_LALT,             LSFT(KC_F10),   MO(_LOWER),         LT(_FUNCTIONS,KC_BSPC),            LT(_FUNCTIONS,KC_BSPC), LT(_RAISE, KC_SPC),            LT(_RAISE, KC_SPC),  MO(_FUNCTIONS), KC_RALT,         KC_RGUI,         KC_RGUI,         KC_RGUI
    ),
    ...
    [_RAISE] = LAYOUT_ortho_5x14(
        KC_GRV,  KC_1,          KC_2,    _______,       _______, _______,                     _______, _______,                     _______,     _______,      _______, _______,  _______, KC_ESC,
    ...
    [_FUNCTIONS] = LAYOUT_ortho_5x14(
        ...
        _______, LCTL(KC_BSPC), _______, _______, _______,    _______,                     _______, _______,                 _______, _______,      _______, _______, _______, _______,
        _______, _______,       _______, _______, LCTL(KC_V), _______,                     _______, _______,                 _______, LSFT(KC_F10), KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT,
        _______, _______,       _______, _______, _______,    _______,                     _______, _______,                 _______, _______,      _______, _______, _______, _______
    ),
	
	[ _MOUSE] = LAYOUT_ortho_5x14(
        _______, _______, _______, _______, _______, _______,                     DYN_MACRO_PLAY1,  DYN_MACRO_PLAY2,                     _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______,                     DYN_REC_START1,   DYN_REC_START2,                      _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______,                     DYN_REC_STOP,     DYN_REC_STOP,                        _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______,                     DYN_REC_STOP,     DYN_REC_STOP,                        _______, _______, _______, _______, _______, _______,
