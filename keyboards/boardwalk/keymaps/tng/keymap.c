...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_ortho_5x14(
        ...
        KC_LCTL,                       KC_LGUI,                             KC_LALT,             MO(_FUNCTIONS), MO(_LOWER),         LT(_FUNCTIONS,KC_BSPC),            LT(_FUNCTIONS,KC_BSPC),  LT(_RAISE, KC_SPC),            LT(_RAISE, KC_SPC),  KC_LEFT, KC_UP,           KC_DOWN,         KC_RGHT,         KC_RCTL
    ),
