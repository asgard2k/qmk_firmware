...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_ortho_5x14(
        C_S_T(KC_GRV),                 MT(MOD_LCTL|MOD_LSFT|MOD_LALT,KC_1), LT(_DVORAK,KC_2),    KC_3,           KC_4,               KC_5,                              KC_MINS,                 KC_EQL,                        KC_6,                KC_7,    KC_8,            KC_9,            KC_0,            LCAG_T(KC_ESC),
    ...
    [_LOWER] = LAYOUT_ortho_5x14(
        ...
        _______, _______,     _______, _______,       _______,        KC_DEL,                      KC_DEL,  KC_SPC,                      KC_SPC,  _______, _______, _______, _______, _______
    ),

    [_RAISE] = LAYOUT_ortho_5x14(
        _______, _______, _______, _______,       _______, _______,                     _______, _______,                     _______,     _______,      _____ __, _______, _______, _______,
        _______, _______, _______, KC_CAPS,       _______, _______,                     _______, _______,                     _______,     KC_PGUP,      KC_UP,   KC_PGDN,  _______, _______,
        _______, _______, _______, LCTL(KC_BSPC), _______, _______,                     _______, _______,                     KC_HOME,     KC_LEFT,      KC_DOWN, KC_RGHT,  KC_END , _______,
