...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_ortho_5x14(
        C_S_T(KC_GRV),                 MT(MOD_LCTL|MOD_LSFT|MOD_LALT,KC_1), LT(_DVORAK,KC_2),    KC_3,           KC_4,               KC_5,                              DYN_REC_START1,          DYN_REC_START2,                KC_6,                KC_7,           KC_8,            KC_9,            KC_0,            LCAG_T(KC_ESC),
        MT(MOD_LCTL|MOD_LALT,KC_TAB),  KC_Q,                                KC_W,                KC_E,           LT(_MOUSE,KC_R),    KC_T,                              DYN_REC_STOP,            DYN_REC_STOP,                  KC_Y,                KC_U,           KC_I,            KC_O,            KC_P,            KC_DEL,
        LSFT_T(KC_CAPS),               KC_A,                                KC_S,                KC_D,           LT(_RAISE,KC_F),    KC_G,                              DYN_MACRO_PLAY1,         DYN_MACRO_PLAY2,               KC_H,                KC_J,           KC_K,            KC_L,            KC_SCLN,         RSFT_T(KC_ENT),
        KC_LSFT,                       KC_Z,                                KC_X,                KC_C,           KC_V,               KC_B,                              DYN_MACRO_PLAY1,         DYN_MACRO_PLAY2,               KC_N,                KC_M,           RALT_T(KC_COMM), RGUI_T(KC_DOT),  RCTL_T(KC_SLSH), RCTL_T(KC_QUOT),
        KC_LCTL,                       KC_LGUI,                             KC_LALT,             MO(_FUNCTIONS), MO(_LOWER),         LT(_FUNCTIONS,KC_BSPC),            LT(_FUNCTIONS,KC_BSPC),  LT(_RAISE, KC_SPC),            LT(_RAISE, KC_SPC),  MO(_FUNCTIONS), LSFT(KC_F10),    KC_LALT,         KC_RGUI,         KC_RCTL
    ),
    ...
    [_LOWER] = LAYOUT_ortho_5x14(
        ...
        _______, LALT(KC_F4), _______, LALT(KC_LEFT), LALT(KC_RIGHT), LCTL(LSFT(KC_ESC)),          _______, _______,                     KC_EXLM, KC_AT,   KC_HASH, KC_LCBR, KC_RCBR, _______,
        _______, _______,     _______, LCTL(KC_PGUP), LCTL(KC_PGDN),  _______,                     _______, _______,                     KC_DLR , KC_LT,   KC_GT,   KC_LBRC, KC_RBRC, _______,
        _______, _______,     _______, _______,       _______,        _______,                     _______, _______,                     _______, KC_PERC, KC_MINS, KC_EQL , KC_BSLS, _______,
    ...
    [_FUNCTIONS] = LAYOUT_ortho_5x14(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,      KC_F,                        _______, _______,                     KC_F6,   KC_F7,        KC_F8,  KC_F9,    KC_F10,  _______,
        _______, KC_F11,  KC_F12,  _______, _______,    _______,                     _______, _______,                     _______, _______,      KC_INS, _______,  KC_PSCR, LCA(KC_DEL),
        _______, _______, KC_SLCK, _______, _______,    _______,                     _______, _______,                     _______, _______,      _______, _______, KC_PAUS, _______,
	...
	[ _MOUSE] = LAYOUT_ortho_5x14(
        ...
        _______, _______, _______, _______, _______, _______,                     _______, _______,                     XXXXXXX, KC_WH_L, XXXXXXX, KC_WH_R, KC_ACL2, _______,
        _______, _______, _______, _______, _______, _______,                     _______, _______,                     _______, _______, _______, _______, _______, _______
    )	 
