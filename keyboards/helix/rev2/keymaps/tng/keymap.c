...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_RAISE] = LAYOUT( \
	KC_GRV , KC_1         , _______     , _______      , _______      , _______      ,                         LCTL(KC_PGUP), LCTL(KC_PGDN) , _______   , _______, _______, KC_ESC, \
 ...
 */
  [_FUNCTIONS] = LAYOUT( \
	...
	_______, _______, _______, _______, LCTL(KC_V), _______   , _______, _______, _______, _______     , _______, _______ , _______ , _______, \
	_______, _______, _______, _______, _______   , _______   , _______, _______, _______, _______     , _______, _______ , _______ , _______ \
  ),
