...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
 [_QWERTY] = LAYOUT( \
              C_S_T(KC_F1), LT(_DVORAK,KC_F2), KC_F3,    KC_F4,                   KC_F5,           KC_F6,    KC_F7,               KC_F8,              KC_F9,          KC_F10,    KC_F11,   LCAG_T(KC_F12), \
    ...
    KC_PGUP,  KC_DEL,       KC_Z,              KC_X,     KC_C,                    KC_V,            KC_B,     KC_N,                KC_M,               KC_COMM,        KC_DOT,    KC_SLSH,  KC_QUOT, \
    KC_PGDN,  KC_LCTRL,     KC_LGUI,           KC_LALT,  LT(_FUNCTIONS,KC_CAPS),  LOWER,           KC_BSPC,  LT(_MOUSE,KC_SPC),   LT(_RAISE, KC_SPC), MO(_FUNCTIONS), KC_RALT,   KC_RGUI,  KC_RCTL \
),
 ...
 */
 [_LOWER] = LAYOUT( \
    ...
    XXXXXXX, _______, LALT(KC_F4), XXXXXXX, LALT(KC_LEFT), LALT(KC_RIGHT), XXXXXXX,         KC_EXLM, KC_AT  , KC_HASH, KC_LCBR, KC_RCBR, _______, \
    _______, _______, XXXXXXX    , XXXXXXX, LCTL(KC_PGUP), LCTL(KC_PGDN) , XXXXXXX,         KC_DLR , KC_LT  , KC_GT  , KC_LBRC, KC_RBRC, _______, \
    _______, _______, XXXXXXX    , XXXXXXX, XXXXXXX,       XXXXXXX,        XXXXXXX,         _______, KC_PERC, KC_MINS, KC_EQL , KC_BSLS, _______, \
 ...
 */
 [_RAISE] = LAYOUT( \
    ...
    _______, _______, XXXXXXX, XXXXXXX, XXXXXXX      , XXXXXXX, XXXXXXX,        MO(_ADJUST), LSFT(KC_F10), KC_UNDS, KC_PLUS, KC_PIPE, _______, \
    _______, _______, _______, _______, _______,       _______, KC_DEL ,        _______,     _______,      _______, _______, _______, _______ \
 ),
 ...
 */
 [_FUNCTIONS] = LAYOUT( \
    ...
    _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, LCTL(KC_V), XXXXXXX,          KC_NLCK, LSFT(KC_F10), XXXXXXX, XXXXXXX, XXXXXXX, _______, \
    _______, _______, _______, _______, _______, _______,    _______,          _______, _______,      _______, _______, _______, _______ \
 ),
