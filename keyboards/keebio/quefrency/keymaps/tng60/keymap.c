...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    KC_LSFT,                      KC_Z,                                KC_X,             KC_C,          KC_V,                   KC_B,                         KC_N,               KC_M,                   RALT_T(KC_COMM), RGUI_T(KC_DOT),  RCTL_T(KC_SLSH),  KC_RSFT, DYN_MACRO_PLAY1,\
    KC_LCTL,                      KC_LGUI,                             KC_LALT,          MO(_LOWER),    LT(_FUNCTIONS,KC_BSPC),                               LT(_RAISE, KC_SPC), MO(_FUNCTIONS),         LSFT(KC_F10),    KC_RALT,         KC_RGUI,          KC_RGUI, KC_RCTL
  ),
  ...
  [_LOWER] = LAYOUT(
    KC_ESC, _______,      _______, _______,       _______,        _______,            _______,             KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, _______, _______, _______, \
    _______, LALT(KC_F4), _______, LALT(KC_LEFT), LALT(KC_RIGHT), LCTL(LSFT(KC_ESC)),                      _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, _______, \
    _______, _______,     _______, LCTL(KC_PGUP), LCTL(KC_PGDN),  _______,                                 _______, KC_LT,   KC_GT  , KC_LBRC, KC_RBRC, _______, _______, \
    _______, _______,     _______, _______,       _______,        _______,                                 KC_LPRN, KC_RPRN, KC_MINS, KC_EQL , KC_BSLS, _______, _______, \
    _______, _______,     _______, _______,       KC_BSPC,                                                 KC_SPC,  _______, _______, _______, _______, _______, _______
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    _______, LCTL(KC_BSPC), _______, _______,    _______,        _______,                                 KC_HOME,     KC_LEFT,      KC_DOWN, KC_RGHT, KC_END , _______, _______, \
  ...
  [_FUNCTIONS] = LAYOUT(
    KC_ESC,  KC_F1,         KC_F2,   KC_F3,   KC_F4,      KC_F5,   KC_F16,           KC_F7,   KC_F8,        KC_F9,  KC_F10,   KC_F11,  KC_F12,  LCA(KC_DEL), _______, \
    _______, _______,       _______, _______, _______,    _______,                   _______, _______,      KC_INS,  _______, KC_PSCR, _______, _______,     _______, \
    _______, LCTL(KC_BSPC), _______, _______, _______,    _______,                   _______, _______,      _______, _______, _______, _______, _______, \
    _______, _______,       _______, _______, LCTL(KC_V), _______,                   _______, LSFT(KC_F10), KC_COMM, KC_DOT,  KC_SLSH, _______, _______, \
    _______, _______,       _______, _______, _______,                               _______, _______,      _______, _______, _______, _______, _______
  ),
  ...
  [_MOUSE] = LAYOUT(
    ...
    _______, DYN_REC_STOP,    DYN_REC_STOP,    _______, _______, _______,                      _______, _______, _______, _______, _______, _______, _______, _______, \
