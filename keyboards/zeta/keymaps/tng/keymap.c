...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  KC_LCTL,         KC_LGUI, KC_LALT, MO(_FUNCTIONS),          MO(_LOWER),        LT(_FUNCTIONS,KC_BSPC),             LT(_RAISE,KC_SPC), MO(_FUNCTIONS),          KC_LEFT,                        KC_DOWN,        KC_RGHT,         KC_UP \
),
              
[_LOWER] =  LAYOUT_ortho_4x12( \
  KC_GRV,  KC_1,        KC_2,    KC_3,          KC_4,           KC_5,                    KC_6,    KC_7,    KC_8,    KC_9   , KC_0,     _______, \
  KC_CAPS, LALT(KC_F4), _______, LCTL(KC_PGUP), LCTL(KC_PGDN),  LCTL(LSFT(KC_ESC)),      _______, KC_LT  , KC_GT  , KC_LBRC, KC_RBRC,  _______, \
...
[_FUNCTIONS] =  LAYOUT_ortho_4x12( \
  ...
  KC_CAPS, KC_F11,        KC_F12,  _______, _______,    _______,                 _______, _______,      _______, _______, KC_PSCR,    _______, \
