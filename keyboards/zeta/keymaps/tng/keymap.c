...
[_QWERTY] = LAYOUT_ortho_4x12( \
  LT(_RAISE,KC_TAB),      KC_Q,    KC_W,    KC_E,                    KC_R,              KC_T,                               KC_Y,              KC_U,                    KC_I,                           KC_O,           KC_P,            KC_ESC, \
  LT(_FUNCTIONS,KC_CAPS), KC_A,    KC_S,    KC_D,                    LT(_RAISE,KC_F),   KC_G,                               KC_H,              KC_J,                    KC_K,                           KC_L,           KC_SCLN,         RSFT_T(KC_ENT), \
  KC_LSFT,                KC_Z,    KC_X,    KC_C,                    KC_V,              KC_B,                               KC_N,              KC_M,                    RALT_T(KC_COMM),                RGUI_T(KC_DOT), RCTL_T(KC_SLSH), KC_QUOT, \
  KC_LCTL,                KC_LGUI, KC_LALT, KC_LSFT,                 MO(_LOWER),        LT(_FUNCTIONS,KC_BSPC),             LT(_RAISE,KC_SPC), MO(_FUNCTIONS),          KC_LEFT,                        KC_DOWN,        KC_RGHT,         KC_UP \
),
              
[_LOWER] =  LAYOUT_ortho_4x12( \
  KC_GRV,  KC_1,        KC_2,    KC_3,          KC_4,           KC_5,                    KC_6,    KC_7,    KC_8,    KC_9   , KC_0,     _______, \
  _______, LALT(KC_F4), _______, LCTL(KC_PGUP), LCTL(KC_PGDN),  LCTL(LSFT(KC_ESC)),      _______, KC_LT  , KC_GT  , KC_LBRC, KC_RBRC,  _______, \
  _______, _______,     _______, LALT(KC_LEFT), LALT(KC_RIGHT), _______,                 KC_LPRN, KC_RPRN, KC_MINS, KC_EQL , KC_BSLS,  _______, \
  _______, _______,     _______, _______,       _______,        _______,                 KC_SPC,  KC_SPC,  _______,  _______, _______, _______ \
),

[_RAISE] =  LAYOUT_ortho_4x12( \
  _______, _______,       _______,      _______,       _______, _______,                 KC_ESC,      KC_PGUP,      KC_UP,   KC_PGDN, _______, KC_DEL, \
