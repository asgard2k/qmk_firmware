...
[_LOWER] =  LAYOUT_ortho_4x12( \
  ...
  _______, _______,     _______, _______,       _______,        KC_BSPC,                            KC_SPC,  _______, KC_DEL,  _______, _______, _______ \
),
...
[_FUNCTIONS] =  LAYOUT_ortho_4x12( \
  _______, KC_F1,  KC_F2,    KC_F3,   _______, _______,                 _______, _______,      _______, _______, KC_PSCR,    LCA(KC_DEL), \
  _______, KC_F4,  KC_F5,    KC_F6,   _______, KC_F12,                  _______, _______,      _______, _______, LCTL(KC_V), _______, \
  _______, KC_F7,  KC_F8,    KC_F9,   KC_F10,  KC_F11,                  _______, LSFT(KC_F10), _______, _______, _______,    _______, \
  _______, _______, _______, _______, _______, _______,                 _______, _______,      _______, _______, _______,    _______ \
),
